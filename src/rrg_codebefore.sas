 ...
 * 24Sep2020 Program flow:
    ...
    processes create __rrgcodebofore and execute it based on input string
...
data rrgcodebefore;
set rrgcodebefore (rename=(ns=tmp));
length ns $ 32000;
...
data rrgcodebefore;
set rrgcodebefore(rename=(ns=string));
