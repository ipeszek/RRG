 ...
 * the only user-specified parameter is STRING. Depending  on system configuration it can be just a name of sas program (typically, macro, e.g. mymacro.sas) 
       but often fully qualified path needs to be used, e.g. C:\pgm\mymacro.sas
